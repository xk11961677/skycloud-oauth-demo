...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Bean("skycloudOAuth2RestTemplate")
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("skycloudOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
